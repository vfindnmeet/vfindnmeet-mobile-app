...
<!-- You feel more drawn to places with busy, bustling atmospheres than quiet, intimate places. -->
<!-- You would love a job that requires you to work alone most of the time. -->
<!-- I'm a person somewhat reserved and distant in communication -->
<!-- I find it difficult to speak loudly -->
<!-- I rapidly get involved in the social life of a new workplace -->
<!-- I spend my leisure time actively socializing with a group of people, attending parties, shopping, etc -->
<!-- It is easy for me to communicate in social situations -->
<!-- I prefer to isolate myself from outside noises -->
<!-- I prefer to spend my leisure time alone or relaxing in a tranquil atmosphere -->
...
s.split("\n").map(i => i.trim()).map(i => i.substring(i.indexOf('<!--') === 0 ? 4 : 0, i.endsWith('-->') ? i.length - 3 : i.length)).map(i => i.trim()).filter(Boolean)
...
<!-- You know at first glance how someone is feeling. -->
<!-- You often have a hard time understanding other people’s feelings. -->
<!-- I feel involved when watching TV soaps
I feel that the world is founded on compassion -->
<!-- I value justice higher than mercy -->
<!-- I easily empathize with the concerns of other people -->
<!-- I'm strongly touched by the stories about people's troubles -->
<!-- When solving a problem I consider the rational approach to be the best -->
<!-- I willingly involve myself in matters which engage my sympathies -->
...
<!-- If your plans are interrupted, your top priority is to get back on track as soon as possible. -->
<!-- You are interested in so many things that you find it difficult to choose what to try next. -->
<!-- I think that everything in the world is relative -->
<!-- Strict observance of the established rules is likely to prevent attaining a good outcome -->
<!-- I believe the best decision is one which can be easily changed -->
<!-- I usually plan my actions in advance -->
<!-- I know how to put every minute of my time to good purpose -->
<!-- As a rule, I proceed only when I have a clear and detailed plan -->
<!-- Deadlines seem to me to be of relative rather than absolute importance -->
<!-- My decisions are based more on the feeling of a moment than on the thorough planning -->
